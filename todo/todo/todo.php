...
if (isset($_POST['cari'])) {
  $cari=$_POST['cari'];
  $sql=" SELECT * FROM tb_todo_iim WHERE tugas LIKE '%$cari%'";
}else{
  $sql="SELECT * FROM tb_todo_iim LIMIT 0,5;";
}

if (isset($_GET['star'])) {
  $star= $_GET['star'];
  $sql="SELECT * FROM tb_todo_iim LIMIT $star,5;";
}

$hasil= mysqli_query($mysqli,$sql);
$sql2= "SELECT * FROM tb_todo_iim";
...
echo "<tr>
 ...
 onclick='return confirm("apakah anda yakin akan menghapusnya?")'> Hapus</a>
 </td>
